...
The final output is a Tableau dashboard allowing exploration of the importance of each metric and how elite players perform relative to the rest of the tour.
...
The datasets are publicly available and widely used for tennis analytics research.
...
2. Feature Engineering:
   - Normalised metrics using rate-based calculations to allow fair comparison across eras and match lengths eg. Ace rate = Aces / Service Games.
   - Players were then grouped into eras for stylistic evolution and analysis of trends over time.
...
# Future improvements
- Court surface specific analysis.
